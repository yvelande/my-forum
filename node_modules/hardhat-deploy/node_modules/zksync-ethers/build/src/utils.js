 ...
 * @constant
 */
exports.ZKSYNC_MAIN_ABI = new ethers_1.utils.Interface(require('../abi/IZkSync.json'));
/**
 * The ABI for the `IContractDeployer` interface, which is utilized for deploying smart contracts.
 * @constant
 */
exports.CONTRACT_DEPLOYER = new ethers_1.utils.Interface(require('../abi/IContractDeployer.json'));
/**
 * The ABI for the `IL1Messenger` interface, which is utilized for sending messages from the L2 to L1.
 * @constant
 */
exports.L1_MESSENGER = new ethers_1.utils.Interface(require('../abi/IL1Messenger.json'));
/**
 ...
 * @constant
 */
exports.IERC1271 = new ethers_1.utils.Interface(require('../abi/IERC1271.json'));
/**
 * The ABI for the `IL1Bridge` interface, which is utilized for transferring ERC20 tokens from L1 to L2.
 * @constant
 */
exports.L1_BRIDGE_ABI = new ethers_1.utils.Interface(require('../abi/IL1Bridge.json'));
/**
...
function isETH(token) {
    return (token.toLowerCase() === exports.ETH_ADDRESS ||
        token.toLowerCase() === exports.L2_ETH_TOKEN_ADDRESS);
}
exports.isETH = isETH;
/**
...
function applyL1ToL2Alias(address) {
    return ethers_1.ethers.utils.hexlify(ethers_1.ethers.BigNumber.from(address)
