...
class RTCPeerConnection extends _eventTargetShim.EventTarget {
  ...
  _registerEvents() {
    (0, _EventEmitter.addListener)(this, 'peerConnectionOnRenegotiationNeeded', ev => {
      ...
      this.dispatchEvent(new _eventTargetShim.Event('negotiationneeded'));
    });
    (0, _EventEmitter.addListener)(this, 'peerConnectionIceConnectionChanged', ev => {
      ...
      this.dispatchEvent(new _eventTargetShim.Event('iceconnectionstatechange'));
    });
    (0, _EventEmitter.addListener)(this, 'peerConnectionStateChanged', ev => {
      ...
      this.dispatchEvent(new _eventTargetShim.Event('connectionstatechange'));
    ...
    (0, _EventEmitter.addListener)(this, 'peerConnectionSignalingStateChanged', ev => {
      ...
      this.dispatchEvent(new _eventTargetShim.Event('signalingstatechange'));
    });
    ...
    (0, _EventEmitter.addListener)(this, 'peerConnectionIceGatheringChanged', ev => {
      ...
      this.dispatchEvent(new _eventTargetShim.Event('icegatheringstatechange'));
    });
...
(0, _eventTargetShim.defineEventAttribute)(proto, 'connectionstatechange');
(0, _eventTargetShim.defineEventAttribute)(proto, 'icecandidate');
(0, _eventTargetShim.defineEventAttribute)(proto, 'icecandidateerror');
(0, _eventTargetShim.defineEventAttribute)(proto, 'iceconnectionstatechange');
(0, _eventTargetShim.defineEventAttribute)(proto, 'icegatheringstatechange');
(0, _eventTargetShim.defineEventAttribute)(proto, 'negotiationneeded');
(0, _eventTargetShim.defineEventAttribute)(proto, 'signalingstatechange');
(0, _eventTargetShim.defineEventAttribute)(proto, 'datachannel');
(0, _eventTargetShim.defineEventAttribute)(proto, 'track');
